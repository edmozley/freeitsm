<?php
/** API: unlink a change from a problem. Thin adapter over ProblemsService::unlinkChange. */
...
try {
    ...
    ProblemsService::unlinkChange($conn, ActorContext::fromSession($conn), $problemId, $changeId);
