<?php
/**
 * API Endpoint: Reorder analyst's ticket dashboard widgets
...
try {
    ...
    $stmt = $conn->prepare("UPDATE analyst_ticket_dashboard_widgets SET sort_order = ? WHERE analyst_id = ? AND widget_id = ?");
