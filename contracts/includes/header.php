...
<div class="header contracts-header">
    ...
    <nav class="header-nav">
        <a href="<?php echo $path_prefix; ?>contracts/" class="nav-btn <?php echo $current_page === 'dashboard' ? 'active' : ''; ?>" title="Contracts">
        ...
        <a href="<?php echo $path_prefix; ?>contracts/suppliers/" class="nav-btn <?php echo $current_page === 'suppliers' ? 'active' : ''; ?>" title="Suppliers">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo $path_prefix; ?>contracts/contacts/" class="nav-btn <?php echo $current_page === 'contacts' ? 'active' : ''; ?>" title="Contacts">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo $path_prefix; ?>contracts/help.php" class="nav-btn <?php echo $current_page === 'help' ? 'active' : ''; ?>" title="Help">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
