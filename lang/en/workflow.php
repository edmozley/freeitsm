...
return [
    ...
    'help' => [
        ...
        'triggers_time_cron'    => '<strong>If those crons aren\'t scheduled, these triggers never fire.</strong> The workflow will sit there, active, doing nothing. SLA events come from the SLA breach-check cron (every 5 minutes); the expiry events from <code>cron/workflow_scheduled.php</code> (hourly is plenty). Setup: <code>docs/workflow-scheduled-cron-setup.md</code>, or <a href="https://github.com/edmozley/freeitsm/wiki/Workflows#time-based-triggers--and-the-problem-of-not-firing-twice" target="_blank" rel="noopener noreferrer">the wiki</a>, which also explains why a still-true condition (a breached SLA stays breached) doesn\'t re-fire every few minutes.',
