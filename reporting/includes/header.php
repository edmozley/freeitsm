...
<div class="header reporting-header">
    ...
    <nav class="header-nav">
        <a href="<?php echo $path_prefix; ?>reporting/logs/" class="nav-btn <?php echo $current_page === 'logs' ? 'active' : ''; ?>" title="System Logs">
        ...
        <a href="<?php echo $path_prefix; ?>reporting/tickets/" class="nav-btn <?php echo $current_page === 'tickets' ? 'active' : ''; ?>" title="Ticket Dashboards">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
