...
<div class="help-section" id="overview">
    <div class="help-section-header"><?php echo helpSectionNum('overview'); ?>
        <div>
            <h3>What demo data is for</h3>
            <p>Demo data populates a FreeITSM install with realistic, pre-built sample records so you can explore how each module looks and behaves with content in it — without spending an afternoon entering test data by hand.</p>
        </div>
    </div>
    ...
    <div class="help-note warn"><strong>For evaluation, not production.</strong> Demo data creates real records in your database (including analyst logins). Use it on a fresh or test install, not on a system that already holds your live data. There is no separate sandbox — everything is added to the database you're connected to.</div>
    <div class="help-note"><strong>Sample analyst logins.</strong> Core Data creates 4 analysts who can all sign in with the password <code>demo1234</code>. These are demo accounts — never leave them on a system that will go live.</div>
</div>

<!-- 2. What's included -->
<div class="help-section" id="whats">
    <div class="help-section-header"><?php echo helpSectionNum('whats'); ?>
        <div>
            <h3>What's included</h3>
            <p>Everything starts with one foundation block, then each module is optional and imported on its own.</p>
        </div>
    </div>
...
<div class="help-section" id="how">
    <div class="help-section-header"><?php echo helpSectionNum('how'); ?>
        <div>
            <h3>How to import</h3>
            <p>Open <strong>System &rarr; Demo data</strong> and work top to bottom. Each module imports on its own with a single click.</p>
        </div>
    </div>
    <div class="help-steps">
        <div class="help-step"><div class="help-step-num">1</div><div><strong>Import Core Data first.</strong> Click <em>Import</em> on the Core Data card at the top. Every per-module button stays disabled until this succeeds, because the other modules reference analysts, users and types from Core Data.</div></div>
        <div class="help-step"><div class="help-step-num">2</div><div><strong>Import the modules you want to see.</strong> Once Core Data is in, the module buttons unlock. Click <em>Import</em> on any module — there's no fixed order and you only need the ones you're evaluating.</div></div>
        <div class="help-step"><div class="help-step-num">3</div><div><strong>Add the cross-module extras.</strong> Once their prerequisites are imported, the <em>Software Installed on Assets</em> and <em>Dashboard Widgets</em> sections appear at the bottom and their buttons unlock.</div></div>
    </div>
    <div class="help-note ok"><strong>It remembers what you've done.</strong> When you reopen the page it checks what already exists, so imported modules show a green tick and don't have to be re-run.</div>
</div>

<!-- 4. Removing demo data -->
<div class="help-section" id="remove">
    <div class="help-section-header"><?php echo helpSectionNum('remove'); ?>
        <div>
            <h3>Removing demo data</h3>
            <p>Anything you import can be removed again from the same page — a module's button turns green once imported, and clicking it again removes that module's demo records.</p>
        </div>
    </div>
