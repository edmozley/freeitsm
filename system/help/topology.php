...
<div class="help-section" id="overview">
    <div class="help-section-header"><?php echo helpSectionNum('overview'); ?>
        <div>
            <h3>What it's for</h3>
            <p>Your configuration is spread across half a dozen System pages — companies here, mailboxes there, sign-in providers somewhere else. Topology gathers all of it into one read-only view, arranged the way you actually think about it: <strong>a company, and everything that hangs off it</strong>.</p>
        </div>
    </div>
    ...
    <div class="help-note"><strong>Nothing here is editable.</strong> Topology only looks. Every row has an <strong>open</strong> or <strong>manage</strong> link that takes you to the page where the thing can actually be changed, so it doubles as a map of where to go next.</div>
</div>
...
<div class="help-section" id="reading">
    <div class="help-section-header"><?php echo helpSectionNum('reading'); ?>
        <div>
            ...
            <p>Despite the name, it isn't a drawn diagram — it's a collapsible tree, which is far easier to scan and to search. Across the top is a strip of totals: companies, mailboxes, sign-in providers, analysts and requesters.</p>
        </div>
    </div>
...
<div class="help-section" id="company">
    <div class="help-section-header"><?php echo helpSectionNum('company'); ?>
        <div>
            <h3>What's under a company</h3>
        </div>
    </div>
    <div class="help-table"><table>
...
<!-- 4. Global & shared -->
<div class="help-section" id="global">
    <div class="help-section-header"><?php echo helpSectionNum('global'); ?>
        <div>
            <h3>Global &amp; shared</h3>
            <p>The last node in the tree isn't a company — it's everything that serves <em>every</em> company: shared mailboxes, global sign-in providers, and the analysts who have all-company access.</p>
        </div>
    </div>
    <div class="help-note"><strong>This is the node to read carefully on a multi-company install.</strong> The all-access analyst list is your answer to &ldquo;who can see every client's tickets?&rdquo; — a question worth asking out loud now and again. If someone is on that list who shouldn't be, fix it on System &rarr; Analysts (or on their team, which may be granting it).</div>
</div>
...
<div class="help-section" id="using">
    <div class="help-section-header"><?php echo helpSectionNum('using'); ?>
        <div>
            ...
            <p>Topology is at its best right after you set something up, and once in a while as a review. A quick pass:</p>
        </div>
    </div>
    <div class="help-steps">
        <div class="help-step"><span class="help-step-num">1</span><div>Does any company carry the amber <strong>no sendable mailbox</strong> tag? Its replies aren't going anywhere. Reconnect or pin a mailbox.</div></div>
        <div class="help-step"><span class="help-step-num">2</span><div>Is every mailbox badge green? An amber <strong>not signed in</strong> means the OAuth connection has lapsed and mail has quietly stopped flowing.</div></div>
        <div class="help-step"><span class="help-step-num">3</span><div>Does each company have the domains you expect? A missing domain is the usual cause of email landing in the wrong company — and the <strong>Email routing test</strong> page will prove exactly which rule decides.</div></div>
        <div class="help-step"><span class="help-step-num">4</span><div>Is the <strong>all-access analysts</strong> list under Global the list you'd have written from memory?</div></div>
        <div class="help-step"><span class="help-step-num">5</span><div>Does any company show zero analysts? Nobody is looking after it.</div></div>
    </div>
</div>
...
<div class="help-section" id="notes">
    ...
    <div class="help-note ok"><strong>Nothing you do here can break anything.</strong> It's read-only. Expand it, scan it, and follow the links to fix whatever looks wrong.</div>
</div>
