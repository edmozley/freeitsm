...
<div class="header tasks-header">
    ...
    <nav class="header-nav">
        ...
        <a href="<?php echo $path_prefix; ?>tasks/calendar/" class="nav-btn <?php echo $current_page === 'calendar' ? 'active' : ''; ?>" title="Calendar">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo $path_prefix; ?>tasks/timeline/" class="nav-btn <?php echo $current_page === 'timeline' ? 'active' : ''; ?>" title="Timeline">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo $path_prefix; ?>tasks/settings/" class="nav-btn <?php echo $current_page === 'settings' ? 'active' : ''; ?>" title="Settings">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
